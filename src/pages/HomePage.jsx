...
export default function HomePage({ requireAuth }) {
    ...
    useEffect(() => {
        async function fetchDeals() {
            ...
            setError(null);
            try {
                const res = await fetch("https://capstone-deals-app-wmbj.vercel.app/deals");
                ...
                const dealsWithImages = await Promise.all(data.map(async (deal) => {
                    ...
                    try {
                        const imgRes = await fetch(`https://capstone-deals-app-wmbj.vercel.app/deals/${deal.deal_id}/images`);
                        if (imgRes.ok) {
    ...
    async function fetchProfile() {
        try {
            ...
            const res = await fetch("https://capstone-deals-app-wmbj.vercel.app/user/profile", {
